                    ...
                    <tbody>
                      <tr>
                        <?php 
                            ...
                            $fetch = mysqli_query($conn, "SELECT * FROM cart JOIN menu ON cart.cart_menu_Id=menu.menu_Id WHERE cart_status='Pending' AND cart_user_Id='$id' ORDER BY menu_name ASC");
